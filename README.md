...
### 🤝 Contributing to
- [flutter_local_notifications](https://github.com/MaikuB/flutter_local_notifications), [thorvg.flutter](https://github.com/thorvg/thorvg.flutter), [llamadart](https://github.com/leehack/llamadart)

### 👯 Side Projects
- [chungmo - Mobile Invitation scrap app with GPT API](https://github.com/TaeBbong/chungmo-app)

### 📫 Lectures
- [Introduce thorvg.flutter](https://speakerdeck.com/taebbong/thorvg-dot-flutter)
- [LLM App with Firebase AI Logic](https://speakerdeck.com/taebbong/don-ansseugo-peulreoteo-aebe-ai-guhyeonhagi-with-firebase-ai-logic)
